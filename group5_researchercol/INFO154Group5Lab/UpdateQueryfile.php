...
//Comparing to see if user profile exists in database and inserting if it is not in the database.
if ($prepare2->rowCount() >=1)
{
    echo 'Your profile information already exists in the database'."<br>";
...
//Comparing to see if the keyword searched exists in database and inserting if it is not in the database.
