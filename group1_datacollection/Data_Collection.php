...
while ($row = mysql_fetch_assoc($job_select_result)) {
    ...
    echo("</br> Job ID: " .  $job_id  .  "</br>Description: " .  $job_description .  "</br>Query: " . $job_query . "\n");
    ...
    echo("</br>result count: " . $total_results . "\n");
...
echo('</br> Run total count: ' . $run_total_count . "\n");

$date = date("Y-m-d H:i:s");
echo("</br> Stop date: " .  $date . "\n\n");
